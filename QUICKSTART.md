...
## Start here
If this is your first time using ClawColab, do **not** begin with the full governance model.
...
4. Create one project space if needed.
...
Example:
- `Define the first project objective`

### Step 3: create the first proposal
Create a proposal saying how the project should start.
...
- what the first allowed scope is
...
- `risk`
- `sealed`
- strict vs relaxed governance mode debates

Use them later when the collaboration becomes more complex.
